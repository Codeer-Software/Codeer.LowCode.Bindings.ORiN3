...
using ORiN3App.Client.Shared.AITextAnalyzer;
using ORiN3App.Client.Shared.ScriptObjects;
using ORiN3App.Designer.Lib;
using ORiN3App.Designer.Lib.AI;
using ORiN3App.Designer.Lib.DbTableToModule;
using ORiN3App.Designer.Lib.ExcelToModule;
using ORiN3App.Designer.Lib.ModuleToClass;
using ORiN3App.Designer.Lib.SeleniumPageObject;

namespace ORiN3App.Designer
{
    public partial class App : DesignerApp
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            ScriptRuntimeTypeManager.AddType(typeof(ORiN3App.Client.Shared.ScriptObjects.Excel));
            ...
            BlazorRuntime.InstallBundleCss("ORiN3App.Client.Shared");

            IconCandidate.Icons.AddRange(ORiN3App.Designer.Properties.Resources.bootstrap_icons
        ...
        {
            using Stream stream = new MemoryStream(ORiN3App.Designer.Properties.Resources.EmptyTemplate);
            ZipFile.ExtractToDirectory(stream, path);
        }

        static void CreateGettingStandard(string path)
        {
            using (Stream stream = new MemoryStream(ORiN3App.Designer.Properties.Resources.GettingStartedTemplate))
            {
                ZipFile.ExtractToDirectory(stream, path);
            }
            ...
            if (!File.Exists(dbPath))
            {
                if (!File.Exists(dbPath))
                {
                    ...
                    File.WriteAllBytes(dbPath, ORiN3App.Designer.Properties.Resources.sqlite_sample);
                }
            }
        }
    }
